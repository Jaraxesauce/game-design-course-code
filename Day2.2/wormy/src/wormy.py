...
def runGame():
    ...
    speedApple = getRandomLocation()
    slowApple = getRandomLocation()
    ...
    while(True): #main game loop
        ...
        if wormCoords[HEAD]['x'] == apple['x'] and wormCoords[HEAD]['y'] == apple['y']:
            apple = getRandomLocation()
        elif wormCoords[HEAD]['x'] == speedApple['x'] and wormCoords[HEAD]['y'] == speedApple['y']:
            speedApple = getRandomLocation()
            FPS = FPS + 2
        elif wormCoords[HEAD]['x'] == slowApple['x'] and wormCoords[HEAD]['y'] == slowApple['y']:
            slowApple = getRandomLocation() 
            FPS = FPS - 1
        else:
            del wormCoords[-1]
        ...
        drawWorm(wormCoords)
        drawApple(apple)
        drawSpeedApple(speedApple)
        drawSlowApple(slowApple)
...
def drawSpeedApple(coord):
    x = coord['x'] * CELLSIZE
    y = coord['y'] * CELLSIZE
    speedAppleRect = pygame.Rect(x, y, CELLSIZE, CELLSIZE)
    pygame.draw.rect(DISPLAYSURF, YELLOW, speedAppleRect)

def drawSlowApple(coord):
    x = coord['x'] * CELLSIZE
    y = coord['y'] * CELLSIZE
    slowAppleRect = pygame.Rect(x, y, CELLSIZE, CELLSIZE)
    pygame.draw.rect(DISPLAYSURF, BLUEGRAY, slowAppleRect)
